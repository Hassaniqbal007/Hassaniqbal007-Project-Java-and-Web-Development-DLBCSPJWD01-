             ...
             <div class="row">
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default p-4">
                        	<div class="row">
                        		<div class="col-sm-10 col-10"><h2 class="h2 text-bold text-info">Customers List</h2></div>
                             ...
                             <table id="zero_config" class="table table-striped table-bordered display nowrap table-sm p-3" style="width: 100%;">
                                      ...
                                      <?php 
            include 'conn.php';
            $sql="SELECT * FROM `users` WHERE `status`='customer'";
            ...
            while($rows =mysqli_fetch_array($run_sql)){
                ...
                echo '
                        <tr>
                            ...
                            <td class="text-nowrap">'.$rows['username'].'</td>
                            <td class="text-nowrap">'.$rows['address'].'</td> 
                            <td class="text-nowrap">'.$rows['contact'].'</td> 
                            <td class="text-nowrap">'.$rows['email'].'</td> 
                            <td class="text-nowrap">'.$rows['type'].'</td> 
                           '; 
                            echo '<td><a class="btn btn-danger text-white btn-sm" href="fumction.php?cus_id='.$rows['id'].'"><i class="mdi mdi-delete"></i></a>&nbsp&nbsp &nbsp&nbsp<a class="btn btn-dark text-white btn-sm" href="edit_customer.php?id='.$rows['id'].'"><i class="mdi mdi-account-edit"></i></a>&nbsp&nbsp &nbsp&nbsp';
                            if($rows['type']=="Individual"){
                                ?>
                                 <a class="btn btn-primary text-white btn-sm" href="cus_booking_list.php?id=<?php echo $rows['username']; ?>"><i class="mdi mdi-calendar-clock"></i></a>
                                ...
                                <?php
                                 ...
                                 ?>
                                 <a class="btn btn-primary text-white btn-sm" href="cust_booking_list.php?id=<?php echo $rows['username']; ?>"><i class="mdi mdi-calendar-clock"></i></a>
