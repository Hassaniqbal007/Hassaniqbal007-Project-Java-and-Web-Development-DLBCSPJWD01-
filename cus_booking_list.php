                ...
                echo '
                        <tr>
                           ...
                           '; 
                            ...
                            echo '<td><a class="btn btn-danger text-white btn-sm" onclick="book_del('.$rows['id'].')"><i class="mdi mdi-delete"></i></a>&nbsp&nbsp &nbsp&nbsp<a class="btn btn-dark text-white btn-sm" href="edit_book.php?id='.$rows['id'].'"><i class="mdi mdi-account-edit"></i></a>
