             ...
             <div class="row">
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default p-4">
                        	<div class="row">
                        		<div class="col-sm-10 col-10"><h2 class="h2 text-bold text-info">Job List</h2></div>
                        		<div class="col-sm-2 col-2"><a class="btn btn-info btn-lg" href="assign_job.php">Assign Job</a></div>
                        		<div class="col-12">
                        			<hr>
                        		</div>
                        	</div>
                             ...
                             <table id="zero_config" class="table table-striped table-bordered display nowrap table-sm p-3" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-nowrap">Garage Name</th>
                                      ...
                                      <?php 
            include 'conn.php';
            $sql="SELECT `job_card`.`id`,`garage`.`garage_name`,`job_card`.`booking_id`,`job_card`.`description`,`job_card`.`date` FROM `job_card` INNER JOIN `garage` ON `job_card`.`garage_name`=`garage`.`id`";
            ...
            while($rows =mysqli_fetch_array($run_sql)){
                ...
                echo '
                        <tr>
                            ...
                            <td class="text-nowrap">'.$rows['booking_id'].'</td> 
                            <td class="text-nowrap">'.$rows['description'].'</td> 
                            <td class="text-nowrap">'.$rows['date'].'</td> 
                           '; 
                            echo '<td><a class="btn btn-danger text-white btn-sm" href="fumction.php?jb_id='.$rows['id'].'"><i class="mdi mdi-delete"></i></a>&nbsp&nbsp &nbsp&nbsp<a class="btn btn-dark text-white btn-sm" href="edit_job.php?id='.$rows['id'].'"><i class="mdi mdi-account-edit"></i></a>
