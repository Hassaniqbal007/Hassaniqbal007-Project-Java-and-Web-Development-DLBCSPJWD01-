...
$contact=$_POST['service_price'];
$email=$_POST['description'];
$address=$_POST['address'];
$customer_type=$_POST['customer_type'];
update_customrr($ser_name,$contact,$email,$address,$customer_type,$id);
                    ...
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h2 class="card-title text-center text-white p-2"><strong>Edit Customer</strong></h2>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-left control-label col-form-label">Customer Name</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="service_name" placeholder="Enter Your Name"
                                                    name="service_name" value="<?php echo $u_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-left control-label col-form-label">Email</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Email" name="description" value="<?php echo $email; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Contact</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="service_price" name="service_price" placeholder="Service Price" value="<?php echo $contact; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Address</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="service_price" name="address" placeholder="Address" value="<?php echo $address; ?>">
                                                </div>
                                            </div>
                                        </div>  <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Customer Type</label>
                                                <div class="col-sm-9">
