...
$city=$_POST['city'];
add_supplier($ser_name,$service_price,$description,$city);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Supplier Address" name="description">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="area" name="area" placeholder="Contact ">
                                                </div>
                                            </div>
                                        </div>
