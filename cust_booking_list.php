             ...
             <div class="row">
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default p-4">
                        	<div class="row">
                        		<div class="col-sm-10 col-10"><h2 class="h2 text-bold text-info">Customer Booking List</h2></div>
                            ...
                            <div class="table-responsive">
                             ...
                             <table id="zero_config" class="table table-striped table-bordered display nowrap table-sm p-3" style="width: 100%;">
                             	<thead>
                                        ...
                                        <tbody>
                                        	<?php
                   $run_sql=mysqli_query($conn,"SELECT *,`booking`.`id` FROM `booking` INNER JOIN `services` ON `booking`.`service` = `services`.`id` WHERE `booking`.`contact_name`='$id'");
            $i=0;
            while($rows =mysqli_fetch_array($run_sql)){
                ...
                echo '
                        <tr>
                            ...
                            <td class="text-nowrap">'.$rows['contact_name'].'</td>
                            ...
                            <td class="text-nowrap">'.$rows['service_name'].'</td> 
                           ...
                           '; 
                            ...
                            echo '<td><a class="btn btn-danger text-white btn-sm" onclick="book_del('.$rows['id'].')"><i class="mdi mdi-delete"></i></a>&nbsp&nbsp &nbsp&nbsp<a class="btn btn-dark text-white btn-sm" href="edit_booking.php?id='.$rows['id'].'"><i class="mdi mdi-account-edit"></i></a>
