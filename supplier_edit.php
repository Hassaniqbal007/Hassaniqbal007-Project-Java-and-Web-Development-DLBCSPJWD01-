...
$city=$_POST['city'];
update_supplier($ser_name,$service_price,$description,$city,$id);
                    ...
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h2 class="card-title text-center text-white p-2"><strong>Supplier</strong></h2>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-left control-label col-form-label">Supplier Name</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="service_name" placeholder="Enter Supplier Name"
                                                    name="service_name" value="<?php echo $s_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-left control-label col-form-label">Address</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Address" name="description" value="<?php echo $address; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Phone #</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="area" name="area" placeholder="Contact" value="<?php echo $contact; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Email</label>
                                                <div class="col-sm-9">
                                                    <input type="email" class="form-control" id="city" name="city" placeholder="Enter Email" value="<?php echo $email; ?>">
                                                </div>
                                            </div>
                                        </div>
