...
$city=$_POST['city'];
update_vehicle($ser_name,$service_price,$description,$city,$id);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Vehicle Model" name="description" value="<?php echo $model; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="area" name="area" placeholder="Year" value="<?php echo $year; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="city" name="city" placeholder="Registraton" value="<?php echo $reg; ?>">
                                                </div>
                                            </div>
                                        </div>
