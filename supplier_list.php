             ...
             <div class="row">
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default p-4">
                        	<div class="row">
                        		<div class="col-sm-10 col-10"><h2 class="h2 text-bold text-info">Supplier List</h2></div>
                        		<div class="col-sm-2 col-2"><a class="btn btn-info btn-lg" href="supplier.php">ADD Supplier</a></div>
                        		<div class="col-12">
                        			<hr>
                        		</div>
                        	</div>
            ...
            while($rows =mysqli_fetch_array($run_sql)){
                ...
                echo '
                        <tr>
                            ...
                            <td class="text-nowrap">'.$rows['supplier_name'].'</td>
                           ...
                           '; 
                            ...
                            echo '<td><a class="btn btn-danger text-white btn-sm" href="fumction.php?sup_id='.$rows['id'].'"><i class="mdi mdi-delete"></i></a>&nbsp&nbsp &nbsp&nbsp<a class="btn btn-dark text-white btn-sm" href="supplier_edit.php?id='.$rows['id'].'"><i class="mdi mdi-account-edit"></i></a>
