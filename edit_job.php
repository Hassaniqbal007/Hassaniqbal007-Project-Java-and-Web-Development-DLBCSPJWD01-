...
if(isset($_GET['id'])){
	$id=$_GET['id'];
	include 'conn.php';
            $sql="SELECT * FROM `job_card` WHERE `id`='$id'";
...
$service_price=$_POST['booking_id'];
$description=$_POST['description'];
$city=$_POST['date'];
update_job($ser_name,$service_price,$description,$city,$id);
                    ...
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h2 class="card-title text-center text-white p-2"><strong>ASSIGN JOB</strong></h2>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-left control-label col-form-label">Garage Name</label>
                                                <div class="col-sm-9">
                                                    <select name="service_name" class="form-control">
                                                        <option value="0">Select Garage</option>
                                                           <?php
                                     include("conn.php");
                                        $get_department=mysqli_query($conn, "SELECT * FROM `garage`");
                                        while($department=mysqli_fetch_array($get_department))
                                        {
                                        $department_id=$department['id'];
                                        $department_name=$department['garage_name'];
                                        if($g_name==$department_id){
                                      ...
                                      echo '<option value="'.$department_id.'">'.$department_name.'</option>';
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-left control-label col-form-label">Booking #</label>
                                                <div class="col-sm-9">
                                                      <select name="booking_id" class="form-control">
                                                        <option value="0">Select Booking</option>
                                                           <?php
                                     include("conn.php");
                                        $get_department=mysqli_query($conn, "SELECT * FROM `booking`");
                                        while($department=mysqli_fetch_array($get_department))
                                        {
                                        $department_id=$department['id'];
                                        $department_name=$department['contact_name'];
                                        if($book==$department_id){
                                            echo '<option value="'.$department_id.'" selected>'.$department_id.' : '.$department_name.'</option>';
                                        }
                                        else{
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Description</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Date</label>
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control" id="date" name="date" placeholder="" value="<?php echo $date; ?>">
                                                </div>
                                            </div>
                                        </div>
