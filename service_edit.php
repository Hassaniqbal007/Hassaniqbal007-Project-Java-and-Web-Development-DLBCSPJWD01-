...
update_service($ser_name,$service_price,$description,$id);
                    ...
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h2 class="card-title text-center text-white p-2"><strong>Services</strong></h2>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-left control-label col-form-label">Service Name</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-left control-label col-form-label">Description</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Service Description" name="description" value="<?php echo $service_price; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Service Price</label>
                                                <div class="col-sm-9">
                                                    <input type="number" class="form-control" id="service_price" name="service_price" placeholder="Service Price" value="<?php echo $description; ?>">
                                                </div>
                                            </div>
                                        </div>
