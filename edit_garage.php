	...
	include 'conn.php';
            ...
            while($rows =mysqli_fetch_array($run_sql)){
                ...
                $i++;
                            ...
                            $location=$rows['garage_location'];
                            $area=$rows['garage_area']; 
                            $city=$rows['garage_city'];
...
$city=$_POST['city'];
update_garage($ser_name,$service_price,$description,$city,$id);
                    ...
                    <div class="col-12">
                        <div class="card border border-info m-5 bg-default">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="card-body">
                                    <h2 class="card-title text-center text-white p-2"><strong>GARAGE</strong></h2>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-left control-label col-form-label">Garage Name</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="service_name" placeholder="Enter Garage Name"
                                                    name="service_name" value="<?php echo $g_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-left control-label col-form-label">Location</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="description" placeholder="Enter Garage Location" name="description" value="<?php echo $location; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">Area</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="uname1" class="col-sm-3 text-left control-label col-form-label">City</label>
                                                <div class="col-sm-9">
